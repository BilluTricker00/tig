...
\033[1;92m   .%>% .%%>' :%>>%%'.,%%%%%%%%%'.%%%%%' `%%%%.`%%%%%.%%%%> %%>%.
\033[1;92m  ,%>%' >>%%  >%' `%%%%'     `%%%%%%%'.,>,. `%%%%'     `%%%>>%%>%
\033[1;92m.%%>%' .%%>'  %>>%, %%\033[1;97m oO ~ Oo %%%>>'.>>>>>>. `% \033[1;97moO ~ Oo'.%%%'%>%,
\033[1;92m%>'%> .%>%>%  %%>%%%'  `\033[1;97mOoooO'.%%>>'.>>>%>>%>>.`%`\033[1;97mOoooO'.%%>% '%>%
\033[1;92m%',%' %>%>%'  %>%>%>% .%,>,>,   `>'.>>%>%%>>>%>.`%,>,>' %%%%> .>%>,
\033[1;92m` %>% `%>>%%. `%%% %' >%%%%%%>,  ' >>%>>%%%>%>>> >>%%' ,%%>%'.%%>>%.
\033[1;92m .%%'  %%%%>%.   `>%%. %>%%>>>%.>> >>>%>%%%%>%>>.>>>'.>%>%>' %>>%>%%
\033[1;92m`.%%  `%>>%%>    %%>%  %>>>%%%>>'.>%>>>>%%%>>%>>.>',%>>%'  ,>%'>% '
...
\033[1;92m                        `////;;;;;;;;;;;;;;;;;/'
\033[1;92m                          `/////////////////'
\033[1;94m«---------\033[1;91m BlackTiger-Error404 \033[1;95m-----------------»
\033[1;92m▶▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇◀
\033[0;31m╭═════════════════════════════ 💀
☛☛\033[1;94m Author =\033[1;92m▶ BlackTiger-Error404
☛☛\033[1;93mYoutube =\033[1;93m▶ Time4 You
☛☛\033[1;92mWhatsapp=\033[1;94m▶ +923037335114
\033[0;31m╰═════════════════════════════ 💀
\033[1;92m▶▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇◀"""
...
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
		print("\r\033[1;96mBlackTiger███████████▒▒▒▒..99%\x1b[1;97m"+o),;sys.stdout.flush();time.sleep(1)
...
jalan('\033[0;97m ‼️ 💀💀💀BLACK TIGER-ERROR404')
jalan('\033[0;97m ‼️ 💀💀💀MY WHATSAPP +923037335114')
...
\033[1;91m•───────────────────────────────•                                                                                                                             
 """
jalan('\033[0;92m⎝🐅⎞ \033[0;96m ☠️  NOTE ☠️   \033[0;92m ⎝☠️⎞ ') 
jalan('\033[0;31m⎝🐅⎞ \033[0;33mOnly education promote \033[0;31m ⎝☠️⎞ ') 
jalan('\033[0;31m⎝🐅⎞ \033[0;33mDo not use any illegal \033[0;31m ⎝☠️⎞ ') 
jalan('\033[0;31m⎝🐅⎞ \033[0;33mI am not responsibilities for you \033[0;31m ⎝☠️⎞ ') 
jalan('\033[0;92m⎝🐅⎞ \033[0;96m  ‼️ THANK ‼️   \033[0;92m ⎝☠️⎞ ') 

print  """\033[0;98mBlackTiger█████████▒▒▒▒▒...100%  """
...
def super():
	...
	os.system('clear')
	print logo
	print "\x1b[1;32;92m[1] \033[1;33;98m👉 ☠️Attack From Friend List"
	print "\x1b[1;32;92m[2] \033[1;33;98m👉 ☠️Attack From Public ID"
	print "\x1b[1;32;92m[3] \033[1;33;98m👉 ☠️Attack From File"
